...
class Review(TypedDict):
    ...
    summary : Annotated[str, "Generate a summary of 30 words."]
    sentiment : Annotated[Literal["Positive", "Negative", "Neutral"], "Return sentiment of the review"] 
    pros : Annotated[Optional[list[str]], "write the pros inside a list"]
    cons : Annotated[Optional[list[str]], "write the cons inside a list"]
